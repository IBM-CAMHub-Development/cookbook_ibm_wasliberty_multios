...
attribute 'ssh/private_key/content',
          :description => 'Liberty private key,
# <md>          :displayname => '
attribute 'ssh/private_key/path',
          :default => '',
          :description => 'Liberty private key path',
          :displayname => 'Absolute path of the Liberty private key',
          :hidden => 'false',
          :parm_type => 'node',
...
attribute 'was_liberty/farm/central_node',
          ...
          :displayname => 'Hostname/IP of the liberty node which will gather and merge the plugins. Leave empty when deploying the central node itself',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/httpd_plugins_dir',
          ...
          :displayname => 'Liberty farm directory on the web server where the merged plugin will be pushed',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/httpd_user',
          ...
          :displayname => 'Liberty farm user for pushing the merged plugin file to the web server host',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/logFileName',
          ...
          :displayname => 'Name of the Liberty farm log file',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/mergedplugins_dir',
          :default => '',
          :description => 'Liberty farm merged plugin directory',
          :displayname => 'The directory where the merged plugins are stored on the central node',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/plugin_cpy_user',
          :default => '',
          :description => 'Liberty plugin copy user',
          :displayname => 'The user for pushing the plugins to the central liberty node',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/plugins_dir',
          :default => '',
          :description => 'Liberty farm plugin dir',
          :displayname => 'The directory where the generated plugins are stored',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/sslCertlabel',
          ...
          :displayname => 'Name of the ssl Cert label which will be added to the keystore',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/sslKeyringLocation',
          ...
          :displayname => 'Full path to the liberty farm ssl Keyring, path must not include the name of the Keyring file',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/sslStashfileLocation',
          ...
          :description => 'Liberty farm ssl Stashfile directory',
          :displayname => 'Full path to the Liberty farm ssl Stashfile, path must not include the name of the stash file',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/webserverName',
          ...
          :displayname => 'A describptive name for the web server',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/farm/webserverSecurePort',
          :description => 'Liberty farm HTTP Secure web server port'
attribute 'was_liberty/farm/webserverhost',
          :default => '',
          :description => 'Liberty web server host',
          :displayname => 'Host name of the web server, not this DNS name must be resolvable',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/force_restart',
          :default => 'true',
          :description => 'Liberty force restart',
          :displayname => 'If set to true, the server will be restarted, if false, the server will not be restarted',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/install_java',
          :default => 'true',
          :description => 'Java install from archives',
          :displayname => 'If true, Java will be installed from archives',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/install_javafp',
          :default => 'true',
          :description => 'Java fixpack flag',
          :displayname => 'If true, a java fixpack will be installed',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/feature',
          ...
          :displayname => 'Lists the Liberty features that should be included in the feature manager list. For example, webProfile-7.0 adminCenter-1.0',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/jvm_params',
          ...
          :displayname => 'Set the default JVM heap sizes for the liberty server, for example, -Xms256m -Xmx2048m',
          :hidden => 'false',
          :parm_type => 'none',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/keystore_password',
          ...
          :displayname => 'Liberty keystore password used to protect the Liberty keystore id, this value will be stored in Chef Vault',
          :hidden => 'true',
          :parm_type => 'node',
          :precedence_level => 'node',
          :regex => '^[!-~]{8,32}$',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/timeout',
          :default => '20',
          :description => 'liberty server timeout',
          :displayname => 'Liberty server timeout value',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/users/admin_user/name',
          ...
          :displayname => 'Administrative console username used for accessing the console, the associated password is the admin_user password',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/users/admin_user/password',
          ...
          :displayname => 'Password for the Liberty administrative user name, this value to be stored in the Chef Vault',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :regex => '^[!-~]{8,32}$',
...
attribute 'was_liberty/liberty_servers/server($INDEX)/users/admin_user/role',
          ...
          :displayname => 'Liberty role for which administrative users are to be added to, the admin_user will be added to this role by default',
          :hidden => 'false',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
